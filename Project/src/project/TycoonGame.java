...
public class TycoonGame extends JFrame implements ItemListener {
	...
	private static Image background = new ImageIcon(Main.class.getResource("../images/introbackGround.jpg")).getImage();
...
//	private JButton leftButton= new JButton(leftButtonBasicImage);
	...
	public TycoonGame() {
		 ...
		 * 
		 * @Override public void mousePressed(MouseEvent e) { //���� or �Ǹ� } });
		 * add(leftButton);
		 * 
		 * rightButton.setVisible(false);//��ó���� ������ �ʴٰ� .�����ϱ��ư ������ ����ȭ��
		 * �Ѿ������ ���ν�ũ���� ���ͼ� ���̱������. rightButton.setBounds(1080, 600, 60,
		 * 60); rightButton.setContentAreaFilled(false);
